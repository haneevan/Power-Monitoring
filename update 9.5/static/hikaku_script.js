$(document).ready(function() {
    ...
    charts.v1 = createChart('vChartU1', '#3B82F6', 220);  // Unit 01 Voltage
    charts.c1 = createChart('cChartU1', '#3B82F6', 3.0); // Unit 01 Current
    charts.v2 = createChart('vChartU2', '#FBBF24', 220);  // Unit 02 Voltage
    charts.c2 = createChart('cChartU2', '#FBBF24', 3.0); // Unit 02 Current
    ...
    // 2. Enable Auto-Scaling for Historical View
    // Setting max to undefined tells Chart.js to calculate the scale automatically
    vChart.options.scales.y.max = undefined; 
    cChart.options.scales.y.max = undefined;
