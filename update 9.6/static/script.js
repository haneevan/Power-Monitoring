$(document).ready(function() {
    ...
    function renderCharts(data) {
        ...
        // Voltage Chart: Fixed at 0 to 220V
        ...
        if (isLiveMode) {
            voltageChart.options.scales.y.min = 180;
            voltageChart.options.scales.y.max = 220;
        }

        // Current Chart: Fixed at 0 to 3.0A
        ...
        if (isLiveMode) {
            ...
            currentChart.options.scales.y.max = 3.0;
        }
